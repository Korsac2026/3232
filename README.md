...
```lua
loadstring(game:HttpGet('https://raw.githubusercontent.com/Korsac2026/3232/main/init.lua', true), 'init.lua')()
```
...
- Review button is shown only to Roblox names in `reviewAccounts` inside `guis/new.lua` (currently `aetherv2owner`, `Korsac2026qq`).
