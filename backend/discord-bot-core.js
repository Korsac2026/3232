...
const generatedText = (result, title = 'Generated premium key') => {
  ...
  const loader = "loadstring(game:HttpGet('https://raw.githubusercontent.com/Korsac2026/3232/main/init.lua', true), 'init.lua')({Closet = false, premiumKey = " + JSON.stringify(rawKey) + '})';
  const content = [
    '✅ **' + title + '**', '',
