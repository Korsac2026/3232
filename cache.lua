...
local function resolveCommit()
	local data = fetchJson('https://api.github.com/repos/Korsac2026/3232/commits/main?per_page=1')
...
local function fetchTree(ref)
	local decoded = fetchJson('https://api.github.com/repos/Korsac2026/3232/git/trees/'..ref..'?recursive=1')
...
local function rawUrl(relative, ref)
	return 'https://raw.githubusercontent.com/Korsac2026/3232/'..(ref or sourceCommit)..'/'..relative
end
